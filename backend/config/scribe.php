...
return [
    ...
    'description' => 'The REST API used by the TaskFlow Nuxt application.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authentication is browser-managed. Do not store a bearer token in localStorage.',
    ],
    ...
    'postman' => [
        ...
        'overrides' => [
            'info._postman_id' => '7c733c5d-faca-4acd-a423-6a06b55821af',
        ],
    ],
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Generated from the current source.',
